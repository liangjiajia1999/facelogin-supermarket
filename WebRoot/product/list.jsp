...
%>
			 		<c:forEach items="${list}" var="product">
			 			<tr>
			 				...
			 				<td><a href="ProductServlet?action=update&pid=${product.pid}">修改</a></td>
			 				<td><a href="ProductServlet?action=delete&pid=${product.pid}&page=${curPage}" onclick="if(confirm('确认删除吗？')==false)return false;">删除</a></td>
			 			</tr>
			 		</c:forEach>
				</table>
